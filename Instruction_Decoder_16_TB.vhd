...
begin
    ...
    process
    begin
        Instruction <= "0001001000000101"; wait for 10 ns; -- MOVI R1,5
        assert Opcode = "0001" and Rd = "001" and Imm_Addr = "0000101" and Imm8 = "00000101"
            report "Decoder MOVI case failed" severity error;

        Instruction <= "0000001010000000"; wait for 10 ns; -- ADD R1,R2
        assert Opcode = "0000" and Rd = "001" and Rs = "010"
            report "Decoder ADD case failed" severity error;

        Instruction <= "0111001000001010"; wait for 10 ns; -- JNZ R1,10
        assert Opcode = "0111" and Rd = "001" and Imm_Addr = "0001010"
